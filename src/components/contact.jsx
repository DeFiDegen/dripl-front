    ...
    return (
      <div className="box">
        ...
        <form id="contact-form" onSubmit={this.handleSubmit.bind(this)}>
          ...
          <button type="submit" disabled={this.state.name && this.state.email && this.state.message ? "" : "true"} className={this.state.name && this.state.email && this.state.message ? "" : "disabled"}>Submit</button>
        </form>
      </div>
    );
  }
